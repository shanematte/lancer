...
import { getTaskCreationInfo, createTask, editTask } from 'features/tasks/ducks/actions';
...
class CreateTask extends Component {
  ...
  componentWillMount = () => {
    ...
    let that = this
    this.setState({
      step: that.props.task.step,
      name: that.props.task.name || '',
      description: that.props.task.description,
      category: that.props.task.category,
      actions_count: that.props.task.actions_count,
      to_top: that.props.task.to_top,
      price: that.props.task.price,
      currency: that.props.task.currency,
      tags: that.props.task.tags,
      multiple_actions: that.props.task.multiple_actions,
      min_worker_rate: that.props.task.min_worker_rate,
      idTask:that.props.task.id
    })

    console.log(that.props.task)
  }
  ...
  render() {
    ...
    return (
      <div>
        ...
        <BodyContainer>
          <FlexBlock>
            <h1 className="title-module__title">Edit a task</h1>
            <div className="steps">
